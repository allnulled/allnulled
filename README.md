...
Bueno. Empezaré por mi parte:
  - El kilogramo de marihuana, debido a su prohibición, vale 10.000€. El de arroz, apenas 1€.
    - ¿A qué responde esta estrategia legislativa?
        - ¿A debilitar a las mafias, o a engrosarlas y fortalecerlas? Le pregunto a interior, sanidad. Porque lo único que hacen es fortalecerlas.
...
Podría reflexionar sobre la conformidad, sobre cómo el uso de sustancias puede alterar la mente lo suficiente como para no ser víctima de la ingeniería social de las élites del grupo, puesto que, simplemente, ninguna persona puede igualar el efecto de la sustancia.
...
Los dato en esto son:
  ...
  - así no se debilitan las mafias: se engrosan. Las tres mafias se fortalecen:
    - la pública: monopolio (Interior) del control de sustancias psicopotenciadoras
    - la privada: monopolio (Sector Farmacéutico) de la producción de sustancias psicopotenciadoras.
    - la ilegal: la tradicionalmente conocida como "mafia", con esos precios por la sustancia, y siendo de los pocos que tienen algo de oferta, lo que consiguen es reclutas prácticamente voluntarios y gratuitos, por la sustancia y su elevadísimo precio y su reducidísima oferta.

Bueno, esa es mi principal parte. Básicamente, porque si voy fumado, no tengo que aguantar vuestras mierdas. Pero me queréis joder, queréis que me coma vuestras mierdas, sí o sí. Por eso, sé que no es por la salud pública que prohiben la Cannabis sativa: es para joderme a mí, y sólo a mí.
Dicho esto, puedo añadir muchas más: que para mí es una medicina, es una protección mental, es un aroma de verdadero hogar.
...
Por esta parte, dejémoslo ahí. Culpables:
  ...
  - Grandes Farmacéuticas e Inversionistas
  - Agencias del Medicamento y Organización Mundial de la Salud
  - Crimen Organizado
  - Intermediarios y otros interesados en el abuso de nicho
...
Pero hay muchas más contradicciones.
  ...
  - George W. Bush y Osama Bin Laden estudiaron en la misma universidad. Pero la gente no exige (a muerte) una educación gratuita generalizada.
  - José Luis Rodríguez Zapatero y M. Rajoy estudiaron en el mismo colegio. ¿Pero nadie exige a muerte educación gratuita?
  - Para optar a un trabajo especializado (la gran mayoría de las demandas de profesionales son trabajos especializados que requieren de homologaciones previas), necesitas conocimiento homologado. ¿Pero nadie exige a muerte educación gratuita?
...
Yo afirmo, en cambio, unos párrafos arriba que no es poderoso: es condición previa al PODER hacer conscientemente.
Es decir, primero SABES, luego PUEDES, y si además QUIERES, entonces lo HACES.
Si te bloquean en el primer round (SABER), te quedas ahí.
...
Personalmente, veo varios problemas en el mundo laboral y su planteamiento.
  ...
  - Desconocimiento de la economía. Este, aunque no lo parezca, es para mí el más grave. Porque desemboca en gente pagada para hacer el mono. Y la lista de monos laborales es larga, incluso puede ser mucho mayor según el criterio para discriminar: monerías/vs/necesidades.
    - Profesiones que podrían ser erradicadas, continúan teniendo profesionales que las defenderán a capa y espada, porque en ellas les va la comida. Por tanto, tendremos a un mono defendiendo su puesto de trabajo-simiesco a ultranza.
      - Por ejemplo, un profesor diciendo que las pantallas los están haciendo tontos. A lo cual, le respondería: "la pantalla podría substituirte a ti, todo el año, 24 horas al día, 365 días al año, sin bajas apenas, o nómina".
...
Evidentemente, no pueden conocer al máximo detalle. Pero nadie, teóricamente, más que estos organismos, conoce el estado verdadero de la economia. ¿Qué pasa? Pues que estos datos no son públicos. Por tanto, nadie, excepto ellos, puede hacer análisis tan sofisticados y completos del estado de la economía. Y, al final, lo usan para limitarte la educación (**¿POR QUÉ?**).
...
Pero... ¿y qué cuernos tiene que ver esto con el empleo? Te lo estoy diciendo. Que buscan el **PLENO EMPLEO**, no la **PLENA SATISFACCIÓN DE LA DEMANDA**. El PLENO EMPLEO es ser tu grano en el culo. La PLENA SATISFACCIÓN es trabajar cuánto sea necesario, para satisfacer las demandas de la sociedad: no las de los ricos, no las de los medio-ricos, no las del mejor postor, sino las de todos, en la medida en que se puedan satisfacer, pero no más, no trabajar para mantener el empleo, no trabajar para mantener las apariencias, no trabajar para tenerte entretenido. Hablo de automatizar el trabajo para conseguir la PLENA SATISFACCIÓN DE LA DEMANDA. Hablo de buscar el **NULO EMPLEO**, en lugar del **PLENO EMPLEO**. No vivimos en el mismo plano, de verdad. Y a mí, tú, no me puedes llamar vago, básicamente porque estoy haciendo del basurero que no quieres hacer, ordenándote la puta casa mientras estoy en la puta mierda, no sé quién eres, pero da igual, seas quién seas, "vago" no es el calificativo para mí. Pero ya te digo de antemano que esta sociedad, para mí, no es. Y no hablo de España, hablo de este puto planeta entero.
...
En la teoría del solipsismo, el hecho de no poder comunicarse con otros, responde a varias intenciones. La primera: la fortaleza solo puede brotar del individuo, del individualismo puro. La fortaleza última y verdadera no puede depender del equipo, sólo del individuo. La otra es que, efectivamente, aquí no hay ni plebe ni élite, aquí solo está el **yo** y el **mundo**. Y en el mundo, se empaquetan todos los demás. Vamos: que no te engañes buscando en los demás, porque los demás son todos lo mismo: mundo. El yo es el yo. Y hay un punto en que buscar en los demás, no sirve. El punto donde el otro extremo de esta comunicación dice: stop. Y te deja de proporcionar. El mundo te puede fallar, vamos.

¿Tanto importa? Bueno. Te hacen creer que perteneces a un colectivo, España (o cualquiera que no cumpla con los requisitos lógicos que estoy exponiendo, vaya). Y en realidad, perteneces a otro: los parguelas fácilmente manejables. Pero, en última instancia, y en la teoría del solipsismo, lo puedes ver en forma positiva: no busques en los demás. Lo dice alguien que ha efectuado investigaciones en redes sociales como Quora o Twitter para buscar gente mediante scripts de JavaScript (la tecnología de la web). Y no sirve de putonada: en Quora hay mucha gente pero que no se puede ver por los algoritmos de ordenación de la plataforma (y dudo que sean reales), y en Twitter, hay muchas trampas, cosas poco creíbles si fuese tan concurrida, pero no me quiero alargar con eso.

En cuanto al resto de formas de telecomunicación, ocurre prácticamente lo mismo. En Facebook, Twitter, Instagram, TikTok... las arquitecturas de estas plataformas te permiten ver a tus vecinos, y a través de los algoritmos de ordenación del servidor. El servidor sería como... el canal de televisión: el árbitro que te dice qué son los otros, qué dicen los otros, pero eso sí, sin enseñarte a los otros.

Esto me recuerda a mi despedida de Facebook: puse un post donde hablaba del intercambio de material bélico entre España y otros del eje europeo y americano, con Arabia Saudí y Qatar, paises pivote que transfirieron material bélico al DAESH/ISIS. Y no me veía nadie, o nadie decía nada. Y me emparanoié, porque no sabía si era que la gente tenía miedo (como yo, aunque no por eso iba a dejar de decirlo), que no les importaba una mierda, o que Facebook me estaba invisibilizando por tocar temas tabú. Y decidí salirme de ese estercolero. Y no volví a entrar en redes sociales de gente conocida. Solo de gente que no conocía. Y no sirve de nada tampoco, seguramente sirve de menos. Pero bueno, tuve que hacer mis investigaciones.
...
¿La solución? Es fácil, cuando le has dado tantas vueltas. O los en fin. Y aunque en fin ellos, no sirve, porque son putos robots de mierda, el que los comanda está más allá, a ese no le tocas.
